...
jQuery(document).ready(function($){
  ...
  var marker_url = ( is_internetExplorer11 ) ? 'img/widgets/gmap2/cd-icon-location2.png' : 'img/widgets/gmap2/cd-icon-location.svg';
  ...
  var contentString = '<div id="content">'+
    '<div id="siteNotice">'+
    '</div>'+
    '<h2 id="firstHeading" class="firstHeading">Brookly</h2>'+
    '<div id="bodyContent">'+
